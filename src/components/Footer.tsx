      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mb-12">
          ...
          <div className="text-center md:text-right md:w-40 flex-shrink-0">
            ...
            <p className="text-gray-500 text-xs uppercase tracking-wider mb-3 mt-6">
              {t('documents')}
            </p>
            <a
              href="https://docs.google.com/document/d/1OWhinJpONnKr_kT8vZvLNL-XSz0VzOROSRWkQeWPThE/edit?tab=t.0"
              target="_blank"
              rel="noopener noreferrer"
